...
export default function ReportsStatisticsPage() {
  ...
  const filteredDocuments = currentDocumentData.filter(doc => {
    const relevantTypes = language === 'vi' ? ['Báo cáo'] : ['Report'];
    ...
    <div className="container mx-auto px-4 py-12">
        <Breadcrumb className="mb-8">
            <BreadcrumbList>
                ...
                <BreadcrumbSeparator />
                <BreadcrumbItem>
                    <BreadcrumbPage>{t('reportsAndStatistics')}</BreadcrumbPage>
                </BreadcrumbItem>
            </BreadcrumbList>
        </Breadcrumb>
      <div className="text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-headline font-bold text-primary">{t('reportsAndStatistics')}</h1>
