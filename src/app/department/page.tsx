...
export default function DepartmentPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <section id="general-introduction" className="scroll-mt-20 text-center mb-16">
      ...
      <section id="functions-mission" className="scroll-mt-20 mb-16">
        ...
        <div className="flex justify-center">
            <Card className="hover:shadow-xl transition-shadow w-full max-w-lg">
                ...
                <CardContent>
                    ...
                    {coreFunctionsContent[language].map((item, index) => <li key={index}>{item}</li>)}
                    </ul>
                </CardContent>
            </Card>
        </div>
      ...
      <section id="history-achievements" className="scroll-mt-20">
